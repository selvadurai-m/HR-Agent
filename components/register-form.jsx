...
export function RegisterForm() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    // Success is handled by auth callback
  };
  ...
  return (
    <div className="flex flex-col gap-6">
      <form onSubmit={handleSignUp} className="flex flex-col gap-6">
        ...
        <div className="grid gap-6">
          ...
          <div className="grid gap-2">
            ...
            <div className="relative group">
              <User2Icon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 group-focus-within:text-violet-500 transition-colors" />
              <Input
                id="name"
                type="text"
      ...
      <Button
        variant="outline"
        className="w-full cursor-pointer border-2 border-gray-200 hover:border-violet-200 hover:bg-violet-50/50 transition-all duration-200"
      ...
      <div className="text-center text-sm mt-4">
        ...
        <a
          href="/login"
          className="text-violet-600 hover:text-violet-700 font-medium underline underline-offset-4 transition-colors"
        >
          Login
        </a>
      </div>
