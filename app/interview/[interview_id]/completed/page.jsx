  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 to-purple-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full bg-white p-8 rounded-3xl shadow-xl text-center border border-gray-100 overflow-hidden relative">
        {/* Decorative elements */}
        <div className="absolute -top-20 -right-20 w-40 h-40 bg-violet-100 rounded-full opacity-20"></div>
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3 relative z-10">
          Interview Submitted{' '}
          <span className="text-violet-600">Successfully</span>
        </h1>

        <p className="text-lg text-gray-600 mb-8 relative z-10">
          Thank you for completing your interview with{' '}
          <span className="font-semibold text-violet-600 bg-violet-50 px-2 py-1 rounded-md">
            Recruiter AI
          </span>
        ...
        <div className="relative z-10 space-y-6 mb-8">
          <div className="flex items-start bg-gradient-to-r from-violet-50 to-white p-4 rounded-xl border border-violet-100">
            <div className="flex-shrink-0 bg-white p-2 rounded-lg mr-4 shadow-sm border border-violet-100">
              <Shield className="h-6 w-6 text-violet-600" />
            </div>
            <div className="text-left">
              <h3 className="font-medium text-gray-900 flex items-center">
                Secure Processing{' '}
                <ChevronRight className="ml-1 h-4 w-4 text-violet-400" />
              </h3>
        ...
        <div className="relative z-10 bg-gradient-to-r from-gray-50 to-white rounded-xl p-5 border border-gray-200 shadow-inner">
          <div className="flex items-center justify-center space-x-2 mb-2">
            <div className="h-1.5 w-1.5 bg-violet-400 rounded-full animate-pulse"></div>
