...
function CandidateFeedbackDialog({ candidate }) {
  ...
  // conversation_transcript directly contains the feedback data (rating, summery, Recommendation, etc.)
  // It may or may not have a nested 'feedback' key depending on how it was saved
  const transcript = candidate?.conversation_transcript || {};
  const feedback = transcript?.feedback || transcript;

  // Get rating from feedback - support both snake_case and camelCase field names
  ...
  const rating = {
    TechnicalSkills:
      ...
      0,
    Communication: rawRating.Communication || rawRating.communication || 0,
    ProblemSolving:
