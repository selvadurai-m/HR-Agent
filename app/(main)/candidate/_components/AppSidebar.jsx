...
import { LogOutIcon, Sparkles, Target } from 'lucide-react';
  ...
  return (
    <Sidebar className="border-r border-gray-100/80 bg-gradient-to-b from-white via-gray-50/30 to-violet-50/20">
      ...
      <SidebarContent className="px-2 mt-2">
        <SidebarGroup className="mt-3 bg-gradient-to-br from-gray-50/80 to-violet-50/50 rounded-2xl p-3 border border-gray-100/60 shadow-sm">
          <SidebarMenu className="space-y-1">
            {SideBarCondidate.map((option, index) => {
              // Use startsWith for dashboard to catch sub-routes
              const isActive =
                option.path === '/candidate/dashboard'
        ...
        {/* Quick Tips Widget */}
        <div className="mx-2 mt-6 p-4 rounded-2xl bg-gradient-to-br from-violet-600 via-purple-600 to-violet-700 text-white shadow-xl shadow-violet-500/30 relative overflow-hidden group">
          ...
          <div className="absolute -left-4 -bottom-4 w-16 h-16 bg-purple-400/20 rounded-full blur-lg group-hover:scale-125 transition-transform duration-500" />
