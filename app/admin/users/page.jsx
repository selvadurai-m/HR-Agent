...
function UserManagement() {
  ...
  const getStatusColor = (user) => {
    ...
    if (user.created_at) return 'text-violet-600 bg-violet-50';
        ...
        <div className="flex gap-2">
          {user?.email?.includes('@superadmin') && (
            <Button
              ...
              className="bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 text-white shadow-lg shadow-violet-500/25 transition-all duration-300"
            >
              + Add Admin
            </Button>
          )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div className="p-2 rounded-lg bg-red-100 group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="text-right">
                      ...
                      <div
                        className={`text-xs px-2 py-1 rounded-full ${getStatusColor(user)}`}
                      >
                        {getStatusText(user)}
                      </div>
                    </div>
