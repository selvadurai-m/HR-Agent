...
function InterviewAnalytics() {
      ...
      const interviewsWithStats = await Promise.all(
        interviewsData.map(async (interview) => {
          try {
            ...
            const completedResults = resultsData.filter(
  ...
  const filterAndSortInterviews = React.useCallback(() => {
    let filtered = interviews.filter((interview) => {
      const title = interview.title || interview.name || 'Untitled Interview';
      const email = interview.email || interview.email || '';
  ...
  const exportInterviewsToCSV = () => {
    const csvContent = [
      ...
      ...filteredInterviews.map((interview) => [
        ...
        interview.email || interview.email || 'N/A',
  ...
  const getStatusColor = (interview) => {
    ...
    if (interview.candidateCount > 0) return 'text-violet-600 bg-violet-50';
          ...
          <div className="flex gap-4">
            ...
            <div className="flex gap-2">
              <select
                ...
                className="px-3 py-2 border border-gray-200 rounded-xl text-sm focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all duration-300"
              >
              ...
              {filteredInterviews.map((interview) => (
                <div key={interview.interview_id} className="relative">
                  <Link
                    ...
                    className="block"
                  >
                    <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-violet-50 transition-colors cursor-pointer">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-500">
                            <span className="flex items-center">
                              ...
                              {interview.email || interview.email || 'Unknown'}
                            </span>
                            <span className="flex items-center">
                      ...
                      <div className="flex items-center space-x-6">
                        ...
                        <div className="text-right">
                          <div
                            className={`text-xs px-2 py-1 rounded-full ${getStatusColor(interview)}`}
                          >
